...
public class DashboardController {
	...
	private void handleNotification() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/NotificationScene.fxml"));
	...
	private void handleHistory() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/MedicalHistoryScene.fxml"));
			Parent root = loader.load();

			Stage stage = (Stage) btnNotification.getScene().getWindow();
			stage.setScene(new Scene(root));
			stage.setTitle("VetClinic - Lịch sử khám");
			stage.show();
		} catch (Exception e) {
			e.printStackTrace();
			AlertUtil.showErrorAlert("Lỗi", "Không thể mở giao diện Thông báo.");
	...
	private void handleSchedule() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/AppointmentScene.fxml"));
			Parent root = loader.load();
	...
	private void handleBook() {
		...
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/customer/BookingScene.fxml"));
			Parent root = loader.load();
	...
	private void handleMyPet() {
		...
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/customer/MyPetScene.fxml"));
			Parent root = loader.load();
	...
	private void handleManageAccount() {
		...
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/fita/vetclinic/views/admin/UserManagementScene.fxml"));
			Parent root = loader.load();
